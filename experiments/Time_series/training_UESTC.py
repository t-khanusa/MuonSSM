...
DATA
'''
data_fold = "/project/khanhnt/HAR_dataset/UESTC/inertial"
modulation_dict = {}
...
parser.add_argument('--num_classes', action="store", dest='num_classes', default=32)
...
csv_filename = 'grid_search_results_UESTC.csv'
